...
class QUAZIP_EXPORT QuaZip {
 ...
 public:
  ...
  /// Sets the OS code (highest 8 bits of the “version made by” field) for new
  /// files.
  /** There is currently no way to specify this for each file individually,
      except by calling this function before opening each file. If this function
     is not called, then the default OS code will be used. The default code is
     set by calling setDefaultOsCode(). The default value at the moment of
     QuaZip creation will be used. */
